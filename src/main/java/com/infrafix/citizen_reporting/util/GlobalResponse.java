...
public class GlobalResponse {
    public static <T> ResponseEntity<T> created(T data, HttpServletRequest request) {
        return (ResponseEntity<T>) new ResponseHandler().handleResponse("DATA SUCCESSFULLY CREATED", HttpStatus.CREATED, data, null, request);
    }
    ...
    public static <T> ResponseEntity<T> internalServerError(String errorCode, HttpServletRequest request) {
        return (ResponseEntity<T>) new ResponseHandler().handleResponse("INTERNAL SERVER ERROR", HttpStatus.INTERNAL_SERVER_ERROR, null, errorCode, request);
    }
    ...
    public static ResponseEntity<Object> incorrectPassword (String errorCode, HttpServletRequest request){
        return new ResponseHandler().handleResponse("INCORRECT PASSWORD", HttpStatus.UNAUTHORIZED, null, errorCode, request);
    }

    public static ResponseEntity<Object> notTechnician (String errorCode, HttpServletRequest request){
        return new ResponseHandler().handleResponse("NOT TECHNICIAN",  HttpStatus.UNAUTHORIZED, null, errorCode, request);
    }
    ...
    public static ResponseEntity<Object> assignFailed (String errorCode, HttpServletRequest request){
        return new ResponseHandler().handleResponse("ASSIGN FAILED",  HttpStatus.INTERNAL_SERVER_ERROR, null, errorCode, request);
    }
    ...
    public static <T> ResponseEntity<T> badRequest (String errorCode, HttpServletRequest request){
        return (ResponseEntity<T>) new ResponseHandler().handleResponse("BAD REQUEST", HttpStatus.BAD_REQUEST, null, errorCode, request);
    }
}
